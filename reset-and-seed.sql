-- Reset database (delete all games first)
DELETE FROM "Review";
DELETE FROM "Game";
DELETE FROM "User" WHERE email != 'admin@cyberdeck.store';
...
-- Insert games with Unsplash images (already configured in next.config.ts)
